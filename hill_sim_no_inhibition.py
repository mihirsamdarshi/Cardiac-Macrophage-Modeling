...
reactions = pd.read_excel('/Users/mihir/Documents/Summer/Models/macrophage_model_no_inhibition.xlsx', sheet_name = 1, skiprows = 1, header = 0)
species = pd.read_excel('/Users/mihir/Documents/Summer/Models/macrophage_model_no_inhibition.xlsx', sheet_name = 0, skiprows = 1, header = 0)
...
plt.subplot(121)
plt.plot(t[:k], yHill_ss[:k,16], label = node_ID[16])
plt.legend(loc='best')
plt.show()
